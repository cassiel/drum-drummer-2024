...
,
		"classnamespace" : "box",
		"rect" : [ 109.0, 112.0, 1386.0, 1175.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1020.0, 785.0, 161.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 20.0, 115.0, 23.0 ],
					"text" : "loadmess set 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.0, 140.0, 169.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1200.0, 1015.0, 150.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1200.0, 990.0, 150.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 365.0, 200.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 15.0, 60.0, 200.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 720.0, 1045.0, 115.0, 23.0 ],
					"text" : "matrix~ 6 6 1."
				}
...
, 			{
				"box" : 				{
					...
					"ignoreclick" : 1,
					"incolormap" : "none",
					"inlabels" : [ "IO", "Other Desert Cities", "---", "---", "---", "---" ],
					"labelwidth" : 95.0,
					"maxclass" : "crosspatch",
					"maxgain" : 2.0,
					"numinlets" : 1,
					...
					"numouts" : 6,
					"outcolormap" : "none",
					"outlabels" : [ "IO", "Other Desert Cities", "---", "---", "---", "---" ],
					"outlettype" : [ "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 855.0, 550.0, 330.0, 220.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 390.0, 690.0, 75.0, 135.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 525.0, 43.0, 30.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 120.0, 760.0, 85.0, 23.0 ],
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 105.0, 825.0, 34.0, 32.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 75.0, 825.0, 34.0, 32.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 255.0, 805.0, 31.0, 23.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 255.0, 835.0, 105.0, 25.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 690.0, 235.0, 92.0, 23.0 ],
					"text" : "mc.adc~ 3 3"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-28",
					"jsarguments" : [ "IO", "A", "B", "C", "D", "E" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1020.0, 840.0, 225.0, 105.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 135.0, 825.0, 87.0, 32.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 225.0, 755.0, 85.0, 23.0 ],
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 615.0, 550.0, 225.0, 220.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 600.0, 290.0, 75.0, 90.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 600.0, 260.0, 70.0, 23.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 765.0, 395.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 720.0, 395.0, 39.0, 23.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 690.0, 430.0, 176.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 690.0, 290.0, 75.0, 90.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 420.0, 195.0, 92.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 170.0, 47.0, 23.0 ],
					"text" : "front"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 420.0, 140.0, 47.0, 23.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 15.0, 100.0, 35.199999999999989, 35.199999999999989 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 15.0, 140.0, 120.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 845.0, 45.0, 45.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 300.0, 185.0, 85.0, 23.0 ],
									"text" : "print PLUG"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 165.0, 25.0, 240.0, 93.0 ],
									"text" : "Max does the routing via plug names, not Node, because we drop events directly into the Max seq. The outputs (e.g. param names) are still by index."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 6,
									"outlettype" : [ "", "", "", "", "", "" ],
									"patching_rect" : [ 645.0, 223.0, 123.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 555.0, 148.0, 131.0, 23.0 ],
									"text" : "route audio plug"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 6,
									"outlettype" : [ "", "", "", "", "", "" ],
									"patching_rect" : [ 270.0, 233.0, 123.0, 23.0 ],
									"text" : "route 1 2 3 4 5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 105.0, 130.0, 115.0, 23.0 ],
									"text" : "route mix plug"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "multichannelsignal", "" ],
									"patching_rect" : [ 660.0, 378.0, 92.0, 23.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "list" ],
													"patching_rect" : [ 615.0, 240.0, 92.0, 23.0 ],
													"style" : "cassiel.abstraction",
													"text" : "dd-24.Ramps"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "list" ],
													"patching_rect" : [ 525.0, 240.0, 92.0, 23.0 ],
													"style" : "cassiel.abstraction",
													"text" : "dd-24.Ramps"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "list" ],
													"patching_rect" : [ 435.0, 240.0, 92.0, 23.0 ],
													"style" : "cassiel.abstraction",
													"text" : "dd-24.Ramps"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "list" ],
													"patching_rect" : [ 345.0, 240.0, 92.0, 23.0 ],
													"style" : "cassiel.abstraction",
													"text" : "dd-24.Ramps"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "list" ],
													"patching_rect" : [ 255.0, 240.0, 92.0, 23.0 ],
													"style" : "cassiel.abstraction",
													"text" : "dd-24.Ramps"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "list" ],
													"patching_rect" : [ 165.0, 240.0, 92.0, 23.0 ],
													"style" : "cassiel.abstraction",
													"text" : "dd-24.Ramps"
												}
...
,
									"patching_rect" : [ 870.0, 556.0, 108.0, 23.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"fontname" : "InputMono",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 855.0, 110.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 765.0, 653.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "multichannelsignal", "" ],
									"patching_rect" : [ 240.0, 378.0, 92.0, 23.0 ],
									"style" : "cassiel.abstraction",
									"text" : "dd-24.VST 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "multichannelsignal", "" ],
									"patching_rect" : [ 450.0, 378.0, 92.0, 23.0 ],
									"style" : "cassiel.abstraction",
									"text" : "dd-24.VST 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "multichannelsignal", "" ],
									"patching_rect" : [ 555.0, 378.0, 92.0, 23.0 ],
									"style" : "cassiel.abstraction",
									"text" : "dd-24.VST 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "multichannelsignal", "" ],
									"patching_rect" : [ 345.0, 378.0, 92.0, 23.0 ],
									"style" : "cassiel.abstraction",
									"text" : "dd-24.VST 2"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 630.0, 130.0, 54.0, 23.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 630.0, 100.0, 90.0, 23.0 ],
													"style" : "cassiel.abstraction",
													"text" : "dd-24.Peak"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 525.0, 130.0, 54.0, 23.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 525.0, 100.0, 90.0, 23.0 ],
													"style" : "cassiel.abstraction",
													"text" : "dd-24.Peak"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 420.0, 130.0, 54.0, 23.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 420.0, 100.0, 90.0, 23.0 ],
													"style" : "cassiel.abstraction",
													"text" : "dd-24.Peak"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 315.0, 130.0, 54.0, 23.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 315.0, 100.0, 90.0, 23.0 ],
													"style" : "cassiel.abstraction",
													"text" : "dd-24.Peak"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 210.0, 130.0, 54.0, 23.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 210.0, 100.0, 90.0, 23.0 ],
													"style" : "cassiel.abstraction",
													"text" : "dd-24.Peak"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 105.0, 100.0, 90.0, 23.0 ],
													"style" : "cassiel.abstraction",
													"text" : "dd-24.Peak"
												}
...
,
									"patching_rect" : [ 705.0, 603.0, 62.0, 23.0 ],
									"saved_object_attributes" : 									{
										"bgcolor" : [ 0.163647, 0.174699, 0.17409, 1.0 ],
										"description" : "",
										"digest" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 30.0, 373.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 855.0, 178.0, 176.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 240.0, 548.0, 207.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 630.0, 666.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 555.0, 225.0, 75.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 555.0, 270.0, 92.0, 23.0 ],
									"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
									"text" : "thispatcher"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 180.0, 666.0, 30.0, 30.0 ]
								}

							}
, 							{
								"box" : 								{
									"comment" : "Output from sequencer or node",
									"id" : "obj-4",
									"index" : 2,
									"maxclass" : "inlet",
									"numinlets" : 0,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 105.0, 55.0, 30.0, 30.0 ]
								}

							}
, 							{
								"box" : 								{
									"comment" : "[name/idx] 0/1: open/close named window",
									"id" : "obj-3",
									"index" : 3,
									"maxclass" : "inlet",
									"numinlets" : 0,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 555.0, 103.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 0 ],
									"midpoints" : [ 383.785714285714278, 653.0, 69.64285714285711, 653.0, 69.64285714285711, 295.0, 669.5, 295.0 ],
									"source" : [ "obj-17", 5 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 303.214285714285722, 599.0, 130.85714285714289, 599.0, 130.85714285714289, 352.0, 354.5, 352.0 ],
									"source" : [ "obj-17", 2 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 356.928571428571445, 640.0, 84.214285714285722, 640.0, 84.214285714285722, 312.0, 564.5, 312.0 ],
									"source" : [ "obj-17", 4 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 330.071428571428555, 620.0, 99.285714285714278, 620.0, 99.285714285714278, 327.0, 459.5, 327.0 ],
									"source" : [ "obj-17", 3 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 276.35714285714289, 581.0, 160.928571428571445, 581.0, 160.928571428571445, 368.5, 249.5, 368.5 ],
									"source" : [ "obj-17", 1 ]
								}
...
,
					"patching_rect" : [ 270.0, 615.0, 62.0, 23.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 45.0, 370.0, 115.0, 23.0 ],
					"text" : "route seq main"
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 400.0, 605.0, 78.0, 25.0 ],
									"style" : "cassiel.number",
									"textcolor" : [ 0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 103.5, 28.5, 389.0, 23.0 ],
									"style" : "c.comment",
...
,
					"patching_rect" : [ 45.0, 565.0, 92.0, 23.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 15.0, 310.0, 398.0, 23.0 ],
					"text" : "route show win seq now master krellmixer crosspatch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 940.0, 180.0, 175.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "dictionary", "", "", "", "" ],
					"patching_rect" : [ 15.0, 895.0, 54.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"legacy" : 1,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 240.0, 900.0, 400.0, 220.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 260.0, 154.0, 23.0 ],
					"saved_object_attributes" : 					{
						"autostart" : 0,
						"defer" : 0,
						"watch" : 0
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1050.0, 990.0, 128.0, 128.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 301.0, 687.0, 349.5, 687.0, 349.5, 238.0, 24.5, 238.0 ],
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.466667, 0.254902, 0.607843, 1.0 ],
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 54.5, 705.5, 363.5, 705.5, 363.5, 224.0, 24.5, 224.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-13::obj-64::obj-28" : [ "vst~[2]", "vst~[1]", 0 ],
