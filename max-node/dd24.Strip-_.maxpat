...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 150.0, 158.0, 35.0 ],
					"style" : "c.comment",
					"text" : "Won't break numbers..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 60.0, 95.0, 283.0, 23.0 ],
					"text" : "regexp _ @substitute \" \" @tosymbol 1"
				}
